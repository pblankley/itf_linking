...
class Observatory:
    ...
    def __init__(self):
        ...
        # as position.
        ObservatoryXYZ = {}
        with open(os.path.join(BASE_DIR, 'ObsCodes.txt'), 'r') as f:
            next(f)
            for line in f:
...
class EarthAndTime:
    ...
    #
    def __init__(self, filename1=os.path.join(BASE_DIR,'finals2000A.all'), filename2=os.path.join(BASE_DIR,'tai-utc.dat')):
        _xydeltat = {}
